...
$fileName = $_SERVER['DOCUMENT_ROOT'].'/folder_upload1/presentationOrder.txt';
...
function getDirContents($dir, &$results = array()) {
    ...
    $len = strlen($_SERVER['DOCUMENT_ROOT'].'/folder_upload1/Presentation');
...
switch($method) {
    // request to update the PresentationOrder.txt and return
    case 'GET':
